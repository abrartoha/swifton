...
export const metadata: Metadata = {
  ...
  description:
    "Contact Swifton Group head office in Melbourne. Send an enquiry to the right brand team — vehicle rental, hospitality, cleaning, security, or careers. We respond promptly.",
